...
public class Cryptos {
	...
	public static String aesEncrypt(String input) {
		try {
			return UtilEncode.encodeHex(aesEncrypt(input.getBytes(DEFAULT_URL_ENCODING), DEFAULT_KEY));
	...
	public static String aesEncrypt(String input, String key) {
		try {
			return UtilEncode.encodeHex(aesEncrypt(input.getBytes(DEFAULT_URL_ENCODING), UtilEncode.decodeHex(key)));
		} catch (UnsupportedEncodingException e) {
			return "";
		}
	}
	...
	public static String generateAesKeyString() {
		return UtilEncode.encodeHex(generateAesKey(DEFAULT_AES_KEYSIZE));
	}
