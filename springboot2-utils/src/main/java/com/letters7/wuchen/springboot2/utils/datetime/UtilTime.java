...
public class UtilTime {
	...
	public static String toTimeString(long time) {
		UtilTime t = new UtilTime(time);
		int day = t.get(UtilTime.DAY);
		int hour = t.get(UtilTime.HOUR);
		int minute = t.get(UtilTime.MINUTE);
		int second = t.get(UtilTime.SECOND);
     ...
     * @param minute    分钟
     */
    public UtilTime(int hour, int minute) {
     ...
     * @param second    秒
     */
    public UtilTime(int hour, int minute, int second) {
...
//    	System.out.println(time);
     ...
     * @param second    秒
     */
    public UtilTime(int day, int hour, int minute, int second) {
     ...
     * @param time      字符串格式的时间
     */
    public UtilTime(String time, String timeSeparator) {
    ...
    public void set(int field, int value) {
        if(value < minFields[field]) {
            throw new IllegalArgumentException(value + ", time paramName must be positive.");
        }
    ...
    public int get(int field) {
        if(field < 0 || field > fields.length - 1) {
            throw new IllegalArgumentException(field + ", field paramName is error.");
        }
        return fields[field];
    }
     ...
     * @return          运算后的时间
     */
    public UtilTime addTime(UtilTime time) {
    	UtilTime result = new UtilTime();
        int up = 0;     // 进位标志
     ...
     * @return          运算后的时间
     */
    public UtilTime subtractTime(UtilTime time) {
    	UtilTime result = new UtilTime();
        int down = 0;       // 退位标志
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final UtilTime other = (UtilTime) obj;
