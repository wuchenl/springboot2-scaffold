...
import com.letters7.wuchen.demo.generator.support.plugins.CustomCommentGenerator;
...
/**
 * @author wlone
 * @date 2018-12-27 09:15:32
 * @desc 用于操作Mybatis-Generator 生成对应代码
 */
public class MybatisGeneratorBridge {
    /**
     * 日志提供器
     */
	private static final Logger log = LoggerFactory.getLogger(MybatisGeneratorBridge.class);
...
//	    configuration.addClasspathEntry(connectorLibPath);
        ...
        jdbcConfig.setDriverClass(DBType.valueOf(dbType).getDbClass());
        jdbcConfig.setConnectionURL(  UtilDataBase.getConnectionUrlWithSchema(selectedDatabaseConfig));
